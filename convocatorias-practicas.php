                ...
                <table id="convocatoriasinanexo" class=" table table-striped display " style="width:100%">
                    ...
                    <tbody class="tabla">
                        <tr>
                            ...
                            <td class="textotabla">
                                <p>001-2020
                                    CONVOCATORIA DE PRACTICAS PROFESIONALES</p>
                                <p class="textoinfocas">
                                    PRACTICAS PROFESIONALES PARA EGRESADOS DE UNIVERSIDADES, PARA LAS AREAS DE CONTROL INSTITUCIONAL, RECURSOS HUMANOS, ADMINISTRACION, SANEAMIENTO AMBIENTAL Y PLANEAMIENTO ESTRATEGICO. <p class="comunicado">COMUNICADO</p>
