        ...
        <div class="row">
            ...
            <div class="row">
                <div class="text-center col-md-8 mx-auto mb-5">
                    <p> El Seguro Integral de Salud (SIS), como Organismo Público Ejecutor (OPE), del Ministerio de Salud, tiene como finalidad proteger la salud de los peruanos que no cuentan con un seguro de salud, priorizando en aquellas poblacionales vulnerables que se encuentran en situación de pobreza y pobreza extrema.
                    </p>
                    <p> Lic. Obst. ANGEL ROJAS URRIETA</p>
                    <p> Jefe de Equipo de la Unidad de Seguros</p>
                </div>
            </div>
        </div>
        <div class="row">
