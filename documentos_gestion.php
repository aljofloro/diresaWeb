                ...
                <div class="col-lg-9 mx-auto">
                    ...
                    <div id="accordionDocumentos" class="accordion">
                                    ...
                                    <table class="tabla_documentos table table-striped display " style="width:100%">
                                        <tbody class="">
                                            <tr>
                                                ...
                                                <td class="texto align-middle">Resolución Directoral N° 002 - 2019</td>
                                                <td class="download">
                                            ...
                                            <tr>
                                                ...
                                                <td class="texto align-middle">Resolución Directoral N° 002 - 2019
                                                </td>
                                                <td class="download">
                                                    <button type="submit" class="btndescargar">DESCARGAR</button>
                                                </td>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFour" aria-labelledby="headingThree" data-parent="#accordionDocumentos" class="collapse">
                                <div class="card-body p-5">
                                    <p class="font-weight-light m-0">Anim pariatur cliche reprehenderit, enim
                                        eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia
                                        aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFive" aria-labelledby="headingThree" data-parent="#accordionDocumentos" class="collapse">
                                <div class="card-body p-5">
                                    <p class="font-weight-light m-0">Anim pariatur cliche reprehenderit, enim
                                        eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia
                                        aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSix" aria-labelledby="headingThree" data-parent="#accordionDocumentos" class="collapse">
                                <div class="card-body p-5">
                                    <p class="font-weight-light m-0">Anim pariatur cliche reprehenderit, enim
                                        eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia
                                        aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSeven" aria-labelledby="headingThree" data-parent="#accordionDocumentos" class="collapse">
                                <div class="card-body p-5">
                                    <p class="font-weight-light m-0">Anim pariatur cliche reprehenderit, enim
                                        eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia
                                        aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt
