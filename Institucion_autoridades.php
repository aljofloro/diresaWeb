            ...
            <div class="container">
                <div class="row">
                    <p>
                        ...
                        <a class="btn-institucion btn" data-toggle="collapse" href="#directorejecutivo" role="button" aria-expanded="false" aria-controls="collapseExample">
                            DIRECTOR EJECUTIVO HOSPITAL HIPOLITO UNANUE
                        </a>
                        <a class="btn-institucion btn" data-toggle="collapse" href="#directorejecutivored" role="button" aria-expanded="false" aria-controls="collapseExample">
                            DIRECTOR EJECUTIVO RED DE SALUD TACNA
                        </a>
                ...
                <div class="row">
                    <div class="mx-auto">
                            ...
                            <div class="col-md-10 mx-auto">
                                ...
                                <div class="autoridades card-body">
                                    <div class="d-flex justify-content-center">
                                        <img src="img/institucion/director.jpg" class="img-fluid" />
                                    </div>
                                    <div class="section_subtitle pb-4">
                                        <p class="nombre">Méd. Juan Manuel Cánepa Yzaga</p>
                                    </div>
                        ...
                        <div class="collapse" id="subdirectora">
                            <div class="col-md-10 mx-auto">
                                <div class="site-section-heading text-center mb-4 col-md-6 mx-auto">
                                    <h2 class="mb-md-4">SUBDIRECTORA REGIONAL</h2>
                                </div>
                                <div class="autoridades card-body">
                                    <div class="d-flex justify-content-center">
                                        <img src="img/institucion/director.jpg" class="img-fluid" />
                        ...
                        <div class="collapse" id="directorejecutivo">
                            <div class="col-md-10 mx-auto">
                                <div class="site-section-heading text-center mb-4 col-md-6 mx-auto">
                                    <h2 class="mb-md-4">DIRECTOR EJECUTIVO HOSPITAL HIPÓLITO UNANUE</h2>
                                </div>
                                <div class="autoridades card-body">
                                    <div class="d-flex justify-content-center">
                                        <img src="img/institucion/director.jpg" class="img-fluid" />
                        ...
                        <div class="collapse" id="directorejecutivored">
                            <div class="col-md-10 mx-auto">
                                <div class="site-section-heading text-center mb-4 col-md-6 mx-auto">
                                    <h2 class="mb-md-4">DIRECTOR EJECUTIVO RED DE SALUD TACNA</h2>
                                </div>
                                <div class="autoridades card-body">
                                    <div class="d-flex justify-content-center">
                                        <img src="img/institucion/director.jpg" class="img-fluid" />
